<?php
/**
 * Code de traitement pour le fichier index_entrainement.php
 * @author : Ilyas DAOUDA
 */
?>
...
<?php
  ...
  if ($stmt = $mysqli->prepare("SELECT titre, description_entrainement, date_entrainement FROM entrainements WHERE estAnnulé = 0 ORDER BY date_entrainement LIMIT 5")) {
